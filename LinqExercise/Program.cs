...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            employees.Where(x => x.Age > 26).OrderBy(x => x.Age).ThenBy(x => x.FirstName).ToList().ForEach(x => Console.WriteLine($"{x.Age} {x.FullName}"));
            Console.WriteLine();
            //TODO: Print the Sum and then the Average of the employees' YearsOfExperience if their YOE is less than or equal to 10 AND Age is greater than 35.
            Console.WriteLine("Total of employees YOE: if years experience < or = 10 & age > 35");
            var sum = employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35).Sum(x => x.YearsOfExperience);
            Console.WriteLine(sum);
            Console.WriteLine();
            Console.WriteLine("Average of employees YOE: if years experience < or = 10 & age > 35");
            ...
            Employee newEmployee = new Employee() { Age = 35, FirstName = "Michael", LastName = "Hartman", YearsOfExperience = 13 };
